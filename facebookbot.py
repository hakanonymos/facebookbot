...
try:
	...
	print "F' \../ `a".center(44)
	print 'ce'.center(44)
	print 'b--oo--k'.center(44)
	print W + ' '
	print ('Bot Facebook').center(44)
	print ' '
...
def baliho():
	try:
		...
		print ' ' + W
		print ('Bot Facebook').center(44)
		print (W + '     [' + G +'Facebook login,Comments,Like .....etc'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
...
def info_ga():
  ...
  -------------       -------------------------------------
   dump_phone         Télécharger tous les numéros de téléphone de tes amis
   dump_mail          Télcharger tous les emails de tes amis
   token              Générer un jeton d'accès 
   bot                Menu(like, commentaire, suprimer tous vos amis,suprimer vos photos,commentaires)
   clear              clear terminal
   help               afficher de l'aide
   about              Afficher les informations sur ce programme
'''%(G,W)
def menu_bot():
	print '''
   %sNumber                  INFO%s
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'hakanonymos@hotmail.com' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'hakanonymos@hotmail.com' + W +'/' + R +'Bot ' + W + '>> ')
...
def main():
  ...
  try:
	cek = raw_input(R + 'hakanonymos@hotmail.com' + W +' >> ')
	...
	if cek.lower() == 'get_data':
		...
		print '\n' + '[*] Generer un jeton d Accès [*]'.center(44) + '\n'
		print '[attention] utiliser un VPN !!!'
		id()
